...
INSERT INTO ev (dol_vin, vin, model_year, make, model, ev_type, elig, ev_range, msrp, electric_ut, owner_loc_id)
WITH _temp_ol_id AS (
SELECT *, DENSE_RANK() OVER (ORDER BY census_tract_2020, p_code, city, county, 
							  us_state, district, pc_point) AS owner_loc_id
FROM _temp)
...
INSERT INTO owner_loc (owner_loc_id, census_tract_2020, p_code, city, county, 
